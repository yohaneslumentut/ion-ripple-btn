...
var RippleBtnDirective = (function () {
    function RippleBtnDirective(el, renderer) {
        ...
        this.endTimeStamp = 0;
        this.btnTapped = new core_1.EventEmitter();
        this.btnPressed = new core_1.EventEmitter();
        this.btnPressup = new core_1.EventEmitter();
        this._darken = false;
    ...
    RippleBtnDirective.prototype.pressUpHandler = function () {
        ...
        this.delay(11).then(function () { if (!_this.isAnimating)
            _this.deactivate(null); }); // wait until ripple animated
    };
    ...
    RippleBtnDirective.propDecorators = {
        ...
        "width": [{ type: core_1.HostBinding, args: ['style.width',] },],
        "backgroundColor": [{ type: core_1.HostBinding, args: ['style.backgroundColor',] },],
        "marginTop": [{ type: core_1.HostBinding, args: ['style.marginTop',] },],
        "interval": [{ type: core_1.Input },],
        "size": [{ type: core_1.Input },],
        "containerClass": [{ type: core_1.Input },],
        "wrapperClass": [{ type: core_1.Input },],
        "tooltipText": [{ type: core_1.Input },],
        "darken": [{ type: core_1.Input },],
        "btnTapped": [{ type: core_1.Output },],
        "btnPressed": [{ type: core_1.Output },],
        "btnPressup": [{ type: core_1.Output },],
    };
    return RippleBtnDirective;
}());
exports.RippleBtnDirective = RippleBtnDirective;
